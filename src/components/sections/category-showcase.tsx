    ...
    <section className="px-4 md:px-6 lg:px-8 py-10 md:py-14 lg:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          <Link href="/empresarial" className="cursor-pointer block group">
          ...
          <Link href="/personalizacao" className="cursor-pointer block group">
        ...
        <div className="text-center mt-10 md:mt-14 max-w-2xl mx-auto">
          <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-between bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
            <p className="text-gray-700 text-base md:text-lg mb-4 !whitespace-pre-line">Independente do seu segmento, temos a solução ideal para uniformes.</p>
            <button className="cursor-pointer bg-[#2e3091] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#252a7a] transition-colors duration-300 shadow-md text-sm md:text-base">
