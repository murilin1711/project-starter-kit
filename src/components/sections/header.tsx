      ...
      <header className="fixed w-full z-50">
        <div className="hidden lg:flex fixed top-0 left-0 right-0 h-[80px] items-center z-50">
          <div className="w-full h-full flex items-center justify-between px-8 xl:px-12 2xl:px-16">
                  ...
                  {navItems.map((item) => (
                    <li key={item} className="relative group">
                      {item === "Sobre" ? (
                        <Link
                          href="/sobre"
                          className="cursor-pointer font-suisse font-normal text-[14px] -tracking-[0.02em] text-black hover:bg-white/80 h-[34px] px-3 rounded-lg transition-all duration-300 whitespace-nowrap group-hover:scale-105 group-hover:shadow-sm flex items-center"
                        >
                          {item}
                        </Link>
                      ) : (
                        <button
                          ...
                          className="cursor-pointer font-suisse font-normal text-[14px] -tracking-[0.02em] text-black hover:bg-white/80 h-[34px] px-3 rounded-lg transition-all duration-300 whitespace-nowrap group-hover:scale-105 group-hover:shadow-sm"
                        >
                          {item}
                        </button>
                      )}
            ...
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <Link href="/" aria-label="Ir para a página inicial/home" className="cursor-pointer">
            ...
            <div className="flex items-center gap-3">
              <div className="relative group">
                <div className={`h-[38px] bg-white/50 backdrop-blur-md rounded-lg shadow-sm transition-all duration-300 ${searchOpen ? 'w-[180px] xl:w-[200px]' : 'w-[90px] xl:w-[100px]'} overflow-hidden group-hover:shadow-md group-hover:scale-105`}>
                  {searchOpen ? (
                    ...
                    <button onClick={() => setSearchOpen(true)} className="cursor-pointer w-full h-full flex items-center justify-between px-3">
              ...
              <Link href="/my-account" aria-label="Log in" className="cursor-pointer relative group font-suisse flex items-center justify-center w-[38px] h-[38px] text-black bg-white/50 backdrop-blur-md rounded-lg shadow-sm hover:bg-white/80 transition-all duration-300 hover:scale-105 hover:shadow-md">
              ...
              <Link href="/wishlist" aria-label="Wishlist" className="cursor-pointer relative group font-suisse flex items-center justify-center w-[38px] h-[38px] text-black bg-white/50 backdrop-blur-md rounded-lg shadow-sm hover:bg-white/80 transition-all duration-300 hover:scale-105 hover:shadow-md">
              ...
              <button aria-label="open cart" className="cursor-pointer relative group font-suisse flex items-center justify-center gap-2 h-[38px] bg-white/50 backdrop-blur-md rounded-lg text-black px-4 shadow-sm hover:bg-white/80 transition-all duration-300 hover:scale-105 hover:shadow-md whitespace-nowrap">
        ...
        <div className="lg:hidden fixed top-0 left-0 right-0 h-[80px] flex items-center justify-between px-4">
          <div className="flex items-center gap-2 z-50">
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Toggle menu" className="cursor-pointer w-[48px] h-[48px] flex items-center justify-center bg-white/50 backdrop-blur-md rounded-full shadow-sm hover:scale-105 transition-transform duration-300">
              {mobileMenuOpen ? <X size={24} /> : <Menu size={24} />}
            </button>
            <button onClick={() => setSearchOpen(!searchOpen)} aria-label="Buscar" className="cursor-pointer w-[48px] h-[48px] flex items-center justify-center bg-white/50 backdrop-blur-md rounded-full shadow-sm hover:scale-105 transition-transform duration-300">
              <Search size={20} />
            </button>
          </div>

          <Link href="/" aria-label="Ir para a página inicial/home" className="cursor-pointer absolute left-1/2 -translate-x-1/2 z-40">
            <Image
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/ROTEIRO_EUROPA-removebg-preview-1765225025878.png"
              alt="Goiás Minas Uniformes Logo"
              width={120}
          ...
          <div className="flex items-center gap-2 z-50">
            <button aria-label="Carrinho" className="cursor-pointer relative w-[48px] h-[48px] flex items-center justify-center bg-white/50 backdrop-blur-md rounded-full shadow-sm hover:scale-105 transition-transform duration-300">
              <ShoppingCart size={20} />
              <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#2e3091] text-white text-[10px] rounded-full flex items-center justify-center">
                0
              </div>
            </button>
            <Link href="/my-account" aria-label="Perfil" className="cursor-pointer w-[48px] h-[48px] flex items-center justify-center bg-white/50 backdrop-blur-md rounded-full shadow-sm hover:scale-105 transition-transform duration-300">
              <User size={20} />
            </Link>
          </div>
        </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-40 pt-[80px]">
            <div className="absolute inset-0 bg-black/20 backdrop-blur-sm cursor-pointer" onClick={() => setMobileMenuOpen(false)} />
                    ...
                    <li key={item}>
                      {item === "Sobre" ? (
                        <Link
                          ...
                          className="cursor-pointer block font-suisse text-[16px] font-medium text-black py-3 px-4 rounded-lg hover:bg-white/80 transition-colors duration-300 hover:scale-105 hover:shadow-sm w-full text-left"
                        >
                          {item}
                        </Link>
                      ) : item === "Escolas" ? (
                        <>
                          <button
                            ...
                            className="cursor-pointer block w-full text-left font-suisse text-[16px] font-medium text-black py-3 px-4 rounded-lg hover:bg-white/80 transition-colors duration-300 flex justify-between items-center"
                          >
                            {item}
                            ...
                            <ul className="pl-6 mt-2 space-y-2">
                              <li>
                                <Link
                                  ...
                                  onClick={() => setMobileMenuOpen(false)}
                                  className="cursor-pointer block text-[#2e3091] font-bold text-[15px] hover:underline"
                                >
                                  Colégio Militar
                                </Link>
                              </li>
              ...
              >
                {item === "Escolas" ? (
                  <div className="flex flex-col items-center gap-4">
                    <Link
                      href="/escolas/colegio-militar"
                      className="cursor-pointer text-[#2e3091] font-bold text-lg hover:underline"
                    >
                      Colégio Militar
                    </Link>
                  </div>
